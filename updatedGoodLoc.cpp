...
MStatus Point::initialize() {
    ...
    input_display =
        nAttr.create("display", "display", MFnNumericData::kBoolean, true);
    ...
    input_cross =
        nAttr.create("cross", "cross", MFnNumericData::kBoolean, true);
    nAttr.setKeyable(true);
    ...
    _colors.append(
        MColor(1.0f, 0.6899999976158142f, 0.6899999976158142f));  // light_red
    ...
    _colors.append(MColor(0.1889999955892563f, 0.6299999952316284f,
                          0.6299999952316284f));  // blue
    _colors.append(
        MColor(0.3919999897480011f, 0.8629999756813049f, 1.0f));  // light_blue
    _colors.append(
        MColor(0.0f, 0.01600000075995922f, 0.37599998712539673f));  // dark_blue
    ...
    _colors.append(MColor(0.62117999792099f, 0.6299999952316284f,
                          0.1889999955892563f));  // dark_yellow
...
MStatus Point::setDependentsDirty(const MPlug& dirty_plug,
